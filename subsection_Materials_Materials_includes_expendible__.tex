...
\begin{enumerate}
\item stereo imaging package. An updated version of the one used in \cite{Henderson_2013} \cite{Camilli_2007}, integrated into a smaller form factor. We require a calibrated stereo pair and sensor suite, as well as the pose offset of each sensor relative to the navigation center \cite{Johnson_Roberson_2013} \cite{Mahon_2008}.
\item drum and line. Typically a series of reef records are collected. Prior to starting, it is important to select the diameter of the drum and length of the line to determine the size of the patch and the image overlap from the spiral spacing. The resulting pattern will have the form shown in Figure \ref{fig:spiral}.
