...
\begin{enumerate}
\item stereo imaging package. An updated version of the one used in \cite{Henderson_2013} \cite{Camilli_2007}, integrated into a smaller package. We require properly calibrated stereo pair and sensor suite, as well as the pose of each sensor relative to the navigation center \cite{Johnson_Roberson_2013} \cite{}.
