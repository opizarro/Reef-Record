...
\item drum and line. Typically a series of reef records are collect. Prior to starting, it is important to select the diameter of the drum and lenght of the line to determine the size of the patch and the image overlap from the spiral spacing. The resulting pattern will have the form \ref{fig:spiral}.
