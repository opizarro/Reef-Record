...
Our approach for systematic, full coverage photographic surveys underwater is to use a line wound around a drum, unwinding the line under tension constrains motion as to generate spiral pattern as it unwinds, which is practical for \sim{100m^{2}} coverage. The curve traced by the tip of the line corresponds to a an involute circle
