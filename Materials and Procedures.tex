...
\end{equation}
The outer boundary of the involute, $r$, grows in a close to linear fashion with the number of revolutions, while the path (or arc) length, $L$, is given by $L=1/2\cdot R\cdot\alpha^2$, growing quadratically with the number of revolutions.
