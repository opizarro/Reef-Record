...
\end{equation}
For a line 6m long, a drum of 0.16m in diameter, the path is shown in Fig. \ref{fig:spiral} and the path length of the spiral pattern is 225 m (Fig. \ref{fig:survey_length}). At a swimming speed of 0.3 m/s, the spiral pattern would take 750 s to execute.
